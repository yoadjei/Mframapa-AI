...
.main-container {
  ...
  box-shadow: 0 10px 50px rgba(2,20,40,0.6), inset 0 1px 0 rgba(255,255,255,0.05);
...
.hero {
  ...
  padding: 28px;
  border-radius: 14px;
  background: linear-gradient(135deg, rgba(2,74,120,0.75), rgba(1,36,66,0.7));
  box-shadow: 0 12px 40px rgba(2,20,40,0.55);
  position:relative;
}
...
.hero:before{
  ...
  width: 60%;
  height: 220%;
  background: radial-gradient(circle at 10% 10%, rgba(124,231,255,0.16), transparent 12%),
              linear-gradient(120deg, rgba(0,229,255,0.08), rgba(124,231,255,0.04));
...
/* FIXED: City input field fully visible with strong contrast */
.stTextInput > div > div > input {
    border-radius: 999px;
    border: 2px solid rgba(124,231,255,0.25);
    padding: 14px 18px;
    font-size: 1rem;
...
.stTextInput > div > div > input:focus {
    border-color: rgba(124,231,255,0.85);
    background: rgba(255,255,255,0.12);
    box-shadow: 0 6px 26px rgba(0,229,255,0.25);
}
...
.feature {
  ...
  border-radius: 12px;
  padding: 18px;
  border-left: 4px solid rgba(124,231,255,0.25);
  min-height:140px;
...
.feature:hover { transform: translateY(-8px); box-shadow: 0 18px 50px rgba(0,0,0,0.65); }
