...
with overview_col1:
    st.metric(
        ...
        "Thousands",
        "Based on spillovers",
        help="Significant pollution transport events detected by satellite and models (source: various studies)"
    )
...
with overview_col2:
    st.metric(
        ...
        "All 195+",
        "Global exposure",
        help="All countries experience cross-border pollution to some degree (source: UNEP, EPA)"
    )
...
with overview_col3:
    st.metric(
        ...
        "600-1000 km",
        "Varies by pollutant",
        help="Typical distance pollution travels across borders (source: studies on PM10 spillovers)"
    )
...
with overview_col4:
    st.metric(
        ...
        "$1T USD/year",
        "Global health costs",
        help="Annual global health costs from transportation-related emissions (source: ICCT study, 2015 data)"
    )
...
with route_tab1:
    ...
    with dust_col1:
        ...
        **🏜️ Sahara Desert → Atlantic & Europe**
        - Peak season: November - March (extended boreal winter)
        - Affects: West Africa, Eastern Mediterranean, Caribbean, Amazon, Europe
        - Distance: Up to 5,000+ km
        - Impact: PM2.5 levels up to 200 μg/m³; 20-30% concentration increase; 680-2460 additional deaths per major event
        
        **🏜️ Asian Dust → Pacific Region**
        - Source: Gobi and Taklamakan deserts
        - Affects: China, Korea, Japan, western North America
        - Peak season: March - May (spring)
    ...
    with dust_col2:
        ...
        saharan_dust = [90, 85, 80, 70, 50, 30, 20, 25, 40, 60, 80, 95]
        asian_dust = [30, 40, 80, 90, 85, 50, 30, 20, 25, 35, 40, 35]
...
with route_tab2:
    ...
    with fire_col1:
        ...
        **🔥 Western North America**
        ...
        - 2023 Example: Canadian wildfires smoke reached NYC
