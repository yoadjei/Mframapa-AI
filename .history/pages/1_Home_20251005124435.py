...
<div class="hero">
  <div style="flex:1; min-width:220px;">
    ...
    <a class="cta" href="#search">Get Started</a>
    <div class="quick-nav">
      <a href="/pages/2_Forecast.py">Forecast</a>
      <a href="/pages/5_Insights.py">Insights</a>
      <a href="/pages/6_Explain.py">Explain</a>
      <a href="/pages/9_Health_Integration.py">Health</a>
      <a href="/pages/7_Policy_Dashboard.py">Policy</a>
      <a href="/pages/12_Crowdsourcing.py">Community</a>
    </div>
  </div>
