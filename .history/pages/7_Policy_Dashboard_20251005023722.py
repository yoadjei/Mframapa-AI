...
with standards_tab1:
    ...
    **📊 WHO Guideline Compliance Worldwide:**
    - Only 17% of cities worldwide meet WHO PM2.5 annual guidelines
    - 99% of global population lives in areas exceeding WHO PM2.5 limits
...
with standards_tab2:
    ...
    epa_data = {
        ...
        'Primary Standard': ['9 μg/m³ (annual)', '150 μg/m³ (24-hr)', '0.070 ppm (8-hr)', 
        ...
        'Last Updated': ['2024', '2006', '2015', '2010', '2010', '1971', '2008']
    }
...
with standards_tab3:
    ...
    pm25_annual = [5, 9, 20, 35, 40, 15]
    no2_annual = [10, 53, 40, 40, 40, 40]  # NO₂ in μg/m³ except US in ppb
    ...
    fig.update_layout(
        ...
        yaxis2=dict(title='NO₂ (ppb/μg/m³)', overlaying='y', side='right'),
        height=400
    )
...
with impact_tab1:
    ...
    with transport_col1:
        ...
        **🚌 Public Transit Investment**
        ...
        - Example: Bogotá BRT reduced emissions by 40%
    ...
    **Success Story: London's ULEZ**
    ...
    - 54% reduction in NO₂ concentrations in central London
    - Substantial reductions in PM2.5 concentrations (25%+)
...
with compliance_col1:
    ...
    **Based on latest available data:**
    ...
    pm25_compliance = [80, 50, 30, 20, 25, 40]  # % of population in compliant areas
